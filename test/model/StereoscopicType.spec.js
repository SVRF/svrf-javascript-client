...
(function(root, factory) {
  ...
  describe('StereoscopicType', function() {
    it('should create an instance of StereoscopicType', function() {
      // uncomment below and update the code to test StereoscopicType
      //var instane = new SVRF.StereoscopicType();
      //expect(instance).to.be.a(SVRF.StereoscopicType);
    });
